...
console.log("Total Order Count:" , total); // Displays total sum of order quantities [20]
...
let inventory = {  // Defines the inventory object
    ...
    calculateTotalValue: function() {  // Defines the method calcaulateTotalValue
        return this.stockCount * this.price;  // Defines the formula to be used
    }
};

console.log("Inventory Details" , inventory); // Displays the object
console.log("Total Value:" , inventory.calculateTotalValue()); // Displays the method calculateTotalValue's result [35]
